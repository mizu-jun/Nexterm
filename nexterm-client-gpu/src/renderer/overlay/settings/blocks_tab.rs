//! Blocks category, migrated onto the shared widget layer (UI/UX v3 P1c).
//!
//! Three rows plus a static tip line. Geometry lives in
//! `overlay/widgets/settings_blocks.rs` and is shared with the mouse
//! hit-test and the AccessKit tree.
...
pub(in crate::renderer) fn draw_blocks_tab(
    ...
    for spec in &build_blocks_widgets(sp, &geometry) {
