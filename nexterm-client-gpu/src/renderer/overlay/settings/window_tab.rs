...
pub(in crate::renderer) fn draw_window_tab(
    ...
    // P2-B: search collapse — visible rows render at compacted slot
    // positions; the hit-test derives Y from the same list.
    ...
    if let Some(row0_slot) = crate::settings_panel::slot_of(&visible, 0) {
        let row0_y = labels_top + row_h * row0_slot as f32;
        ...
        let opacity_line =
            truncate_to_width(&opacity_line, layout.label_w + layout.control_w, cell_w);
        add_string_verts(
            &opacity_line,
            content_inner_x,
            row0_y,
            search_label_color(sp, &opacity_line, opacity_color, tokens),
            focus == 0,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row1_slot) = crate::settings_panel::slot_of(&visible, 1) {
        let row1_y = labels_top + row_h * row1_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row1_y,
            search_label_color(sp, &cs_label, cs_label_color, tokens),
            focus == 1,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row2_slot) = crate::settings_panel::slot_of(&visible, 2) {
        let row2_y = labels_top + row_h * row2_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row2_y,
            search_label_color(sp, &px_label, px_color, tokens),
            focus == 2,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row3_slot) = crate::settings_panel::slot_of(&visible, 3) {
        let row3_y = labels_top + row_h * row3_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row3_y,
            search_label_color(sp, &py_label, py_color, tokens),
            focus == 3,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row4_slot) = crate::settings_panel::slot_of(&visible, 4) {
        let row4_y = labels_top + row_h * row4_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row4_y,
            search_label_color(sp, &pm_label, pm_color, tokens),
            focus == 4,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row5_slot) = crate::settings_panel::slot_of(&visible, 5) {
        let row5_y = labels_top + row_h * row5_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row5_y,
            search_label_color(sp, &row5_label, row5_color, tokens),
            focus == 5,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row6_slot) = crate::settings_panel::slot_of(&visible, 6) {
        let row6_y = labels_top + row_h * row6_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row6_y,
            search_label_color(sp, &row6_label, row6_color, tokens),
            focus == 6,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row7_slot) = crate::settings_panel::slot_of(&visible, 7) {
        let row7_y = labels_top + row_h * row7_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row7_y,
            search_label_color(sp, &row7_label, row7_color, tokens),
            focus == 7,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row8_slot) = crate::settings_panel::slot_of(&visible, 8) {
        let row8_y = labels_top + row_h * row8_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row8_y,
            search_label_color(sp, &row8_label, row8_color, tokens),
            focus == 8,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row9_slot) = crate::settings_panel::slot_of(&visible, 9) {
        let row9_y = labels_top + row_h * row9_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row9_y,
            search_label_color(sp, &row9_label, row9_color, tokens),
            focus == 9,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row10_slot) = crate::settings_panel::slot_of(&visible, 10) {
        let row10_y = labels_top + row_h * row10_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row10_y,
            search_label_color(sp, &row10_label, row10_color, tokens),
            focus == 10,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row11_slot) = crate::settings_panel::slot_of(&visible, 11) {
        let row11_y = labels_top + row_h * row11_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row11_y,
            search_label_color(sp, &row11_label, row11_color, tokens),
            focus == 11,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row12_slot) = crate::settings_panel::slot_of(&visible, 12) {
        let row12_y = labels_top + row_h * row12_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row12_y,
            search_label_color(sp, &row12_label, row12_color, tokens),
            focus == 12,
            sw,
            sh,
            cell_w,
    ...
    if let Some(row13_slot) = crate::settings_panel::slot_of(&visible, 13) {
        let row13_y = labels_top + row_h * row13_slot as f32;
        ...
        add_string_verts(
            ...
            content_inner_x,
            row13_y,
            search_label_color(sp, &row13_label, row13_color, tokens),
            focus == 13,
            sw,
            sh,
            cell_w,
