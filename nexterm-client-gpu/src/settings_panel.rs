...
impl SettingsPanel {
    ...
    // ===== Security category: consent policies + byte caps =====
    //
    // Fields: 0=external_url / 1=osc52_clipboard / 2=osc_notification /
    // 3=plugin_read / 4=osc52_max_bytes / 5=notification_max_bytes /
    // 6=plugin_read_max_bytes. Up/Down moves between fields; Left/Right cycles
    // the focused policy (0..=3); Enter edits a byte cap (4..=6).
    ...
    pub fn security_field_label(idx: u8) -> &'static str {
        match idx {
            0 => "External URL:",
            1 => "OSC 52 clipboard:",
            2 => "Notification:",
            3 => "Plugin read:",
            4 => "OSC 52 max bytes:",
            5 => "Notification max bytes:",
            6 => "Plugin read max bytes:",
            _ => "",
        }
    }
